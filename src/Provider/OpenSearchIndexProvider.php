...
class OpenSearchIndexProvider implements IndexProviderInterface, PreConfiguredIndexProviderInterface
{
    ...
    public function preConfigureIndex(IndexDocument $indexDocument): void
    {
        ...
        try {
            ...
            throw new ProviderException(sprintf('Error while creating index: %s', $e->getMessage()), DsOpenSearchBundle::PROVIDER_NAME, $e);
        }
    }
    ...
    public function coolDown(ContextDefinitionInterface $contextDefinition): void
    {
        ...
        try {
            ...
            throw new ProviderException(sprintf('Error while committing to index: %s', $e->getMessage()), DsOpenSearchBundle::PROVIDER_NAME, $e);
        }
    ...
    public function processDocument(ContextDefinitionInterface $contextDefinition, IndexDocument $indexDocument): void
    {
        try {
            ...
            throw new ProviderException($e->getMessage(), DsOpenSearchBundle::PROVIDER_NAME, $e);
        }
    }
    ...
    protected function executeIndex(ContextDefinitionInterface $contextDefinition, IndexDocument $indexDocument): void
    {
        ...
        try {
            ...
            throw new ProviderException(sprintf('Error while persisting data: %s', $e->getMessage()), DsOpenSearchBundle::PROVIDER_NAME, $e);
        }
    ...
    protected function executeInsert(ContextDefinitionInterface $contextDefinition, IndexDocument $indexDocument): void
    {
        ...
        try {
            ...
            throw new ProviderException(sprintf('Error while persisting and committing data: %s', $e->getMessage()), DsOpenSearchBundle::PROVIDER_NAME, $e);
        }
